...
export const TOOLS_FALLBACK: ToolTab[] = [
  {
    ...
    description:
      'Tailored resources at your fingertips—handpicked to align with your goals, challenges, and aspirations.',
    videoSrc: {
      id: 'progress-tracking',
  ...
  },
  {
    ...
    description:
      'Based on your needs and interests we display a series of relevant articles that will help you to achieve your goals.',
    videoSrc: {
      id: 'curated-articles',
  ...
  },
  {
    ...
    description:
      'Be part of a vibrant community, and share progress and motivation in the group. Grow together!',
    videoSrc: {
      id: 'networking',
      name: 'Networking',
      video: [
