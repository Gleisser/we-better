...
const HeaderActions = (): JSX.Element => {
  ...
  const profileLabel = (t('header.profile') as string) || 'Profile';
  ...
  return (
    <div className={styles.actionsContainer}>
      ...
      {/* Utility cluster: theme / notifications / profile */}
      <div className={styles.utilityGroup}>
        ...
        <button
          ...
          title={t('header.toggleTheme') as string}
        >
          <svg
        ...
        <div className={styles.notificationContainer}>
          <button
            ...
            title={t('header.notifications') as string}
