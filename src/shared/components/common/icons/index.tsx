...
export const ArrowTopRight = ({ className }: IconProps): JSX.Element => (
...
export const ArrowRight = ({ className }: IconProps): JSX.Element => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14m-5-5l5 5-5 5" />
  </svg>
);

export const GalleryIcon = ({ className }: IconProps): JSX.Element => (
...
export const MobileNavIcon = ({ className }: IconProps): JSX.Element => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    stroke="currentColor"
...
export const MobileNavNextIcon = ({ className }: IconProps): JSX.Element => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    stroke="currentColor"
...
export const AIMarketingIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M3 3v18h18" stroke="url(#paint0_linear)" strokeWidth="2" strokeLinecap="round" />
    <path
      d="M7 14l4-4 4 4 5-5"
      ...
      strokeLinejoin="round"
    />
    <circle cx="7" cy="14" r="2" fill="none" stroke="url(#paint0_linear)" strokeWidth="2" />
    <circle cx="11" cy="10" r="2" fill="none" stroke="url(#paint0_linear)" strokeWidth="2" />
    <circle cx="15" cy="14" r="2" fill="none" stroke="url(#paint0_linear)" strokeWidth="2" />
    <circle cx="20" cy="9" r="2" fill="none" stroke="url(#paint0_linear)" strokeWidth="2" />
    <defs>
      <linearGradient
        id="paint0_linear"
        x1="3"
...
export const AIGraphicDesignIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path
...
export const AIPrintOnDemandIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    {/* Printer body */}
    <path
    ...
    />
    {/* Paper tray */}
    <path d="M6 14h12v8H6v-8z" stroke="url(#paint2_linear)" strokeWidth="2" strokeLinecap="round" />
    {/* Top paper */}
    <path d="M6 2h12v4H6V2z" stroke="url(#paint2_linear)" strokeWidth="2" strokeLinecap="round" />
    {/* Printer details */}
    <circle cx="18" cy="11" r="1" fill="url(#paint2_linear)" />
    <defs>
      <linearGradient
        id="paint2_linear"
        x1="2"
...
export const AIMarketingToolsIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    {/* Camera body */}
    <rect x="2" y="6" width="20" height="14" rx="2" stroke="url(#paint3_linear)" strokeWidth="2" />
    {/* Camera lens */}
    <circle cx="12" cy="13" r="4" stroke="url(#paint3_linear)" strokeWidth="2" />
    {/* Flash/top detail */}
    <path d="M7 4h10" stroke="url(#paint3_linear)" strokeWidth="2" strokeLinecap="round" />
    {/* Small light/button */}
    <circle cx="17" cy="9" r="1" fill="url(#paint3_linear)" />
    <defs>
      <linearGradient
        id="paint3_linear"
        x1="2"
...
export const AIInteriorDesignIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    {/* Sofa base */}
    <path
    ...
    />
    {/* Sofa seat */}
    <path d="M4 18h16" stroke="url(#paint4_linear)" strokeWidth="2" strokeLinecap="round" />
    {/* Sofa back */}
    <path
...
export const AIArchitectureIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    {/* Building base */}
    <path d="M3 21h18" stroke="url(#paint5_linear)" strokeWidth="2" strokeLinecap="round" />
    ...
    />
    {/* Door */}
    <path d="M10 21v-3h4v3" stroke="url(#paint5_linear)" strokeWidth="2" strokeLinecap="round" />
    <defs>
      <linearGradient
        id="paint5_linear"
        x1="3"
...
export const AINewsIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path
...
export const WikiIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path
...
export const FAQIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    <circle cx="12" cy="12" r="10" stroke="url(#paint8_linear)" strokeWidth="2" />
    <path
...
export const MobileMenuArrowIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} width="12" height="8" viewBox="0 0 12 8">
    <path d="M1 1L6 6L11 1" stroke="currentColor" strokeWidth="2" />
  </svg>
);

export const ButtonArrowIcon = ({ className }: IconProps): JSX.Element => (
  <svg
    className={className}
    width="20"
    height="20"
...
export const ShowcaseArrowIcon = ({ className }: IconProps): JSX.Element => (
  <svg
    viewBox="0 0 24 24"
    className={className}
    stroke="currentColor"
...
export const ShowcaseArrowRightIcon = ({ className }: IconProps): JSX.Element => (
  <svg
    viewBox="0 0 24 24"
    className={className}
    stroke="currentColor"
...
export const ShowcaseMobileArrowIcon = ({ className }: IconProps): JSX.Element => (
  <svg
    viewBox="0 0 24 24"
    className={className}
    stroke="currentColor"
...
export const ShowcaseMobileArrowRightIcon = ({ className }: IconProps): JSX.Element => (
  <svg
    viewBox="0 0 24 24"
    className={className}
    stroke="currentColor"
...
export const CollapseIcon = ({ className }: IconProps): JSX.Element => (
...
export const TrashIcon = ({ className }: IconProps): JSX.Element => (
...
export const SparkleIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const MoreVerticalIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const MicrophoneIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const StopIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const PencilIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const CheckmarkIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" className={className}>
    <path
      d="M5 13l4 4L19 7"
      stroke="currentColor"
...
export const DotsHorizontalIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const SkipForward15Icon = ({ className = '' }: { className?: string }): JSX.Element => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
...
export const StarFilledIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
  </svg>
);

export const StarEmptyIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
  </svg>
);
...
export const SkillsIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ChevronUpIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 15l7-7 7 7" />
  </svg>
);

export const ThumbUpIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ThumbDownIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const TagIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const BlockIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const EyeOffIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const HashtagIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const FlagIcon = ({ className }: IconProps): JSX.Element => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const VolumeOffIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Add these new icons
export const MinimizeIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const MaximizeIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ClockIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const CalendarIcon = ({ className }: IconProps): JSX.Element => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const RefreshIcon = ({ className }: { className?: string }): JSX.Element => (
  <svg
    viewBox="0 0 24 24"
    className={className}
    fill="none"
